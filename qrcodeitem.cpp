...
QRCodeItem::QRCodeItem(QQuickItem *parent)
{
    color(QColor(0,0,0,255));
       ...
       setWidth(_size);
       setHeight(_size);
       connect(this,&QRCodeItem::textChanged,this,[=]{update();});
       connect(this,&QRCodeItem::colorChanged,this,[=]{update();});
       connect(this,&QRCodeItem::bgColorChanged,this,[=]{update();});
       connect(this,&QRCodeItem::sizeChanged,this,[=]{
           setWidth(_size);
           setHeight(_size);
           update();
       });
